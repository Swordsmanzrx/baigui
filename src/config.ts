...
export const siteConfig: SiteConfig = {
	title: "Baigui's Home",
	subtitle: "大风起兮云飞扬，威加海内兮归故乡，安得猛士兮守四方！",
	...
	banner: {
		enable: true,
		src: "assets/images/huili.jpg", // Relative to the /src directory. Relative to the /public directory if it starts with '/'
...
export const profileConfig: ProfileConfig = {
	...
	name: "Augustus Gattuso",
	bio: "代码如风，常伴吾身。一个热爱技术、向往自由的开发者。",
	links: [
		{
			name: "Luogu",
